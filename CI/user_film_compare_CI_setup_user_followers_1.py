...
outfile = open("CI/user_film_compare_CI_user_followers_1.py","w")
...
indata = indata.replace("outfile = open('Output/'+user1+'_'+user2+'_output.txt','w')","outfile = open('CI/user_film_compare_CI_user_followers_1.txt','w')")
indata = indata.replace("with open('Output/'+user1+'_'+user2+'_output.csv', mode='w') as outfile:","with open('CI/user_film_compare_CI_user_followers_1.csv', mode='w') as outfile:")
